...
const About = () => {
  return (
    <section className="about text-right px-4" dir="rtl">
      <h3>عن التطبيق ؟</h3>
      <p>
        تم بناء هذا التطبيق بناءا على تطبيق صراحة الشهير والهدف منه كان هو بهدف
        التعلم فقط لا النسخ او السرقة !؟
      </p>

      <h4>ماهي التقنيات المستخدمة ؟؟</h4>
      <p>reactjs , react hooks , firebase </p>

      <br />
      <p>لمشاهدة المزيد من الاعمال يرجى زيارة موقعي الشخصي </p>
      <a
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 550.18 217.97">
            ...
            <g id="Layer_2" data-name="Layer 2">
              <g id="Layer_1-2" data-name="Layer 1">
                ...
                />
                <path className="cls-2" d="M380.84,203.55s.22-42,.46-86.83" />
                <path
                  className="cls-2"
